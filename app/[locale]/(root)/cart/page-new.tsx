...
import SmartCartRecommendations from '@/components/shared/product/smart-cart-recommendations'
...
export default function CartPage() {
  ...
  return (
    <div>
      <div className='grid grid-cols-1 md:grid-cols-4  md:gap-4'>
        {items.length === 0 ? (
          <Card className='col-span-4 rounded-none'>
            ...
            <CardContent>
              Continue shopping on {site.name}
            </CardContent>
          </Card>
        ) : (
          <>
      ...
      <SmartCartRecommendations cartItems={items} />

// Local AI functions that work without external APIs

export const getGeminiResponse = async (prompt: string) => {
    // Return mock responses when external APIs are unavailable
    return 'AI service running in offline mode. Using local intelligence.'
}
